...
class Pro_Settings {
	...
	public function __construct() {
		...
		add_action( 'happyfiles/settings/permissions/bottom', [$this, 'render_setting_svg_files' ] );
	 ...
	 */
	public function render_setting_svg_files() {
		?>
		<tr>
			<th>
			...
			<td>
				...
				foreach ( $user_roles as $name => $label ) {
					$svg_support = ! empty( Settings::$svg_support[$name] ) ? Settings::$svg_support[$name] : '';
