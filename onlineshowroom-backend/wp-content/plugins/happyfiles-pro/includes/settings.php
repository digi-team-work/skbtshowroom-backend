...
class Settings {
	...
	public function register_settings() {
		...
		register_setting( HAPPYFILES_SETTINGS_GROUP, 'happyfiles_filesizes' ); // PRO

		// Permissions (per user role)
		register_setting( HAPPYFILES_SETTINGS_GROUP, 'happyfiles_folder_access' );
		register_setting( HAPPYFILES_SETTINGS_GROUP, 'happyfiles_svg_support' ); // PRO
  }
