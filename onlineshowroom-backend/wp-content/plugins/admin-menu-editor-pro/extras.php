...
wsEditorData.importMenuNonce = "<?php echo esc_js(wp_create_nonce('import_custom_menu'));  ?>";
	...
	public function register_extra_scripts() {
		...
		wp_register_auto_versioned_script(
			...
			array('ame-knockout', 'jquery', 'jquery-ui-dialog', 'ame-lodash', 'wp-color-picker')
		);
		wp_register_auto_versioned_script(
			'ame-pro-common-lib',
		...
		wp_register_auto_versioned_script(
			...
			array('jquery', 'ame-knockout', 'jquery-ui-dialog', 'wp-color-picker', 'ame-lodash', 'ame-ko-extensions',),
			true
		);
	}
